...
def smile_detection():   # this function is for smile detection
    face_cascade = cv2.CascadeClassifier('C:/Users/lenovo/Anaconda3/Lib/site-packages/cv2/data/haarcascade_frontalface_default.xml')
    eye_cascade = cv2.CascadeClassifier('C:/Users/lenovo/Anaconda3/Lib/site-packages/cv2/data/haarcascade_eye.xml')
    smile_cascade = cv2.CascadeClassifier('C:/Users/lenovo/Anaconda3/Lib/site-packages/cv2/data/haarcascade_smile.xml')
...
def upper_body_detection():
    ...
    body_cascade = cv2.CascadeClassifier('C:/Users/lenovo/Anaconda3/Lib/site-packages/cv2/data/haarcascade_mcs_upperbody.xml')
